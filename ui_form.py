...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 996, 313))
        ...
        self.scrollArea_3.setMaximumSize(QSize(16777215, 55))
        self.scrollArea_3.setFrameShape(QFrame.NoFrame)
        self.scrollArea_3.setWidgetResizable(True)
        self.scrollAreaWidgetContents_3 = QWidget()
        self.scrollAreaWidgetContents_3.setObjectName(u"scrollAreaWidgetContents_3")
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 996, 55))
        ...
        self.gridLayout_2.addWidget(self.scrollArea_3, 5, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.groupBox_3, 6, 1, 1, 1)
        ...
        self.gridLayout_2.addLayout(self.horizontalLayout_2, 7, 1, 2, 1)
        ...
        self.gridLayout_2.addLayout(self.verticalLayout_3, 2, 0, 5, 1)
        ...
        self.gridLayout_2.addLayout(self.gridLayout_4, 7, 0, 2, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"AKTUALNA KONFIGURACJA MASZYNY", None))
    # retranslateUi
